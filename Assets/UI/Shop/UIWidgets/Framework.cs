...
namespace Unity.UIWidgets
{
    ...
    public class TextRenderObject : RenderObject
    {
        ...
        public TextRenderObject(string value)
        {
            ...
            VisualElement.size = TextSize.XXXL;
            VisualElement.style.color = new StyleColor(Color.blue);
        }
    ...
    public abstract class DiagnosticPropertiesBuilder
    {
        public object defaultDiagnosticsTreeStyle { get; set; }

        public void add(ObjectFlagProperty<int> p0)
        {
           // throw new NotImplementedException();
        }
    }

    public abstract class CanonicalMixinDiagnosticableTree
    {
    ...
    {
        public UIWidgetsError(string theBuildownerSchedulebuildforMethodShouldOnlyBeCalledWhileThe)
        {
    ...
    {
        public EnumProperty(string lifecycleState, _StateLifecycle debugLifecycleState,
            _StateLifecycle defaultValue)
        {
            //throw new NotImplementedException();
        }
    }
    ...
    public abstract class D
    {
        ...
        public static void assert(bool func)
        {
    ...
    {
        protected void debugFillProperties(DiagnosticPropertiesBuilder properties)
        {
    ...
    public class BuildOwner
    {
        ...
        internal void _debugTrackElementThatWillNeedToBeRebuiltDueToGlobalKeyShenanigans(Element node,
            GlobalKey key)
        {
                    ...
                    try
                    {
                            ...
                            this._debugElementsThatWillNeedToBeRebuiltDueToGlobalKeyShenanigans.isNotEmpty())
                        {
                            ...
                            if (keys.isNotEmpty())
                            {
                                ...
                                var elements = this._debugElementsThatWillNeedToBeRebuiltDueToGlobalKeyShenanigans
                                    .Keys;
    ...
    public class ErrorWidget : LeafRenderObjectWidget
    {
        ...
        //key: new UniqueKey()
        public ErrorWidget(Exception exception) : base()
        {
    ...
    public abstract class ComponentElement : Element
    {
        ...
        protected override void performRebuild()
        {
            ...
            {
                //WidgetsD._debugReportException("building " + this, e)
                built = ErrorWidget.builder(new UIWidgetsErrorDetails());
            }
            finally
            {
                this._dirty = false;
            ...
            D.assert(() =>
            {
                ...
                if (this.state._debugLifecycleState == _StateLifecycle.created)
                {
                    throw new UIWidgetsError(
                        ...
                        ") or inheritFromElement() was called before " +
    ...
    internal class WidgetsD
    {
        ...
        public static void _debugReportException(string whileRebuildingDirtyElements, Exception exception,
            Action<object> informationCollector)
        {
            //throw new NotImplementedException();
        }
    }
